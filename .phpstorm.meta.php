...
'telescope.watchers.Laravel\\Telescope\\Watchers\\RequestWatcher.ignore_status_codes','telescope.watchers.Laravel\\Telescope\\Watchers\\ScheduleWatcher','telescope.watchers.Laravel\\Telescope\\Watchers\\ViewWatcher','concurrency.default','view.paths',
...
'sanctum.csrf-cookie','telescope','dashboard','mesocycles','mesocycles.create','mesocycles.current',
'mesocycles.store','mesocycles.edit','mesocycles.update','mesocycles.activate','mesocycles.destroy',
'days.show','days.toggle','sets.store','sets.update','sets.destroy',
'dayExercises.store','dayExercises.reorder','dayExercise.destroy','profile.edit',
'profile.update','profile.destroy','register',
'login','demo.login','password.request','password.email',
...
'WWWUSER','WWWGROUP','BCRYPT_ROUNDS','MASTER_EMAIL','MASTER_PASSWORD',
...
'MEMCACHED_HOST','REDIS_CLIENT','CACHE_DRIVER','REDIS_HOST','REDIS_PASSWORD',
...
'SCOUT_DRIVER','MEILISEARCH_HOST','MEILISEARCH_NO_ANALYTICS','MEILI_MASTER_KEY',);
