<template>
	<div class="rounded overflow-hidden">
		<!-- Header -->
		<button @click="toggle" class="w-full flex justify-between items-center px-4 py-2 transition">
			<span>{{ title }}</span>
			<svg :class="['transform transition-transform duration-200', isOpen ? 'rotate-180' : 'rotate-0']" width="16"
