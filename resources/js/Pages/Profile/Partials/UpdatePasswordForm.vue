    ...
    <section>
        ...
        <form @submit.prevent="updatePassword" class="mt-6 space-y-6">
            <div>
                ...
                <InputText id="current_password" ref="currentPasswordInput" v-model="form.current_password"
            ...
            <div>
                ...
                <InputText id="password" ref="passwordInput" v-model="form.password" type="password"
